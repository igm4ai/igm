...
class TestUtilsUrl:
    def test_get_url_filename(self):
        ...
        assert get_url_filename(get_testfile_url('sdjlk873jdf%20.pdf'), 'application/pdf') \
               == 'sdjlk873jdf .pdf'
        assert get_url_filename(get_testfile_url('sdjlk873jdf%20'), 'application/pdf') \
               == 'sdjlk873jdf .pdf'
    ...
    def test_get_url_ext(self):
        ...
        assert get_url_ext(get_testfile_url('sdjlk873jdf%20.tar.gz'), 'application/pdf') == '.tar.gz'
        assert get_url_ext(get_testfile_url('sdjlk873jdf%20'), 'application/pdf') == '.pdf'
